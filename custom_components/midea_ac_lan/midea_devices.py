...
MIDEA_DEVICES: dict[int, dict[str, dict[str, Any] | str]] = {
    ...
    0xED: {
        ...
        "entities": {
            ...
            EDAttributes.life4: {
                "type": Platform.SENSOR,
                "translation_key": "filter4_life",
                "name": "Filter4 Life Level",
                "icon": "mdi:percent",
                "unit": PERCENTAGE,
                "state_class": SensorStateClass.MEASUREMENT,
            },
            EDAttributes.life5: {
                "type": Platform.SENSOR,
                "translation_key": "filter5_life",
                "name": "Filter5 Life Level",
                "icon": "mdi:percent",
                "unit": PERCENTAGE,
                "state_class": SensorStateClass.MEASUREMENT,
            },
            EDAttributes.maxlife1: {
                "type": Platform.SENSOR,
                "translation_key": "filter1_maxlife",
                "name": "Filter1 Lifetime Limit",
                "icon": "mdi:air-filter",
                "unit": UnitOfTime.MONTHS,
                "state_class": SensorStateClass.MEASUREMENT,
            },
            EDAttributes.maxlife2: {
                "type": Platform.SENSOR,
                "translation_key": "filter2_maxlife",
                "name": "Filter2 Lifetime Limit",
                "icon": "mdi:air-filter",
                "unit": UnitOfTime.MONTHS,
                "state_class": SensorStateClass.MEASUREMENT,
            },
            EDAttributes.maxlife3: {
                "type": Platform.SENSOR,
                "translation_key": "filter3_maxlife",
                "name": "Filter3 Lifetime Limit",
                "icon": "mdi:air-filter",
                "unit": UnitOfTime.MONTHS,
                "state_class": SensorStateClass.MEASUREMENT,
            },
            EDAttributes.maxlife4: {
                "type": Platform.SENSOR,
                "translation_key": "filter4_maxlife",
                "name": "Filter4 Lifetime Limit",
                "icon": "mdi:air-filter",
                "unit": UnitOfTime.MONTHS,
                "state_class": SensorStateClass.MEASUREMENT,
            },
            EDAttributes.maxlife5: {
                "type": Platform.SENSOR,
                "translation_key": "filter5_maxlife",
                "name": "Filter5 Lifetime Limit",
                "icon": "mdi:air-filter",
                "unit": UnitOfTime.MONTHS,
                "state_class": SensorStateClass.MEASUREMENT,
            },
            ...
            EDAttributes.water_kind: {
                "type": Platform.SENSOR,
                "translation_key": "water_kind",
                "name": "Water Kind",
                "icon": "mdi:water",
                "device_class": SensorDeviceClass.ENUM,
                "options": {
            ...
            EDAttributes.ice_gall_status: {
                "type": Platform.SENSOR,
                "translation_key": "ice_gall_status",
                "name": "Ice Gall Status",
                "icon": "mdi:snowflake",
                "state_class": SensorStateClass.MEASUREMENT,
            },
            EDAttributes.filter: {
            ...
            EDAttributes.standby_status: {
                "type": Platform.BINARY_SENSOR,
                "translation_key": "standby_status",
                "name": "Standby Status",
                "icon": "mdi:power-standby",
            },
            EDAttributes.out_water: {
                "type": Platform.BINARY_SENSOR,
