    ...
    0xC3: {
        ...
        "entities": {
            ...
            C3Attributes.wifi_module_serial: {
                ...
                "name": "WiFi Module Serial / Identification",
                "icon": "mdi:identifier",
            ...
            C3Attributes.fan_speed: {
                ...
                # POZOR: presne vyznamy urovni (LEVEL_1..4) nejsou oficialne
                # potvrzeny - jde o obecne pojmenovani diskretnich stupnu
                # (raw hodnoty 10/20/30/40), ne skutecne ot./min.
            ...
            C3Attributes.temp_t1: {
                ...
                "name": "T1 Temperature (Total Outlet Water)",
                "device_class": SensorDeviceClass.TEMPERATURE,
                "unit": UnitOfTemperature.CELSIUS,
                "state_class": SensorStateClass.MEASUREMENT,
                "default": False,
            ...
            C3Attributes.temp_t2: {
                ...
                "name": "T2 Temperature (Refrigerant Liquid)",
                "device_class": SensorDeviceClass.TEMPERATURE,
                "unit": UnitOfTemperature.CELSIUS,
                "state_class": SensorStateClass.MEASUREMENT,
                "default": False,
            ...
            C3Attributes.temp_t2b: {
                ...
                "name": "T2B Temperature (Refrigerant Gas)",
                "device_class": SensorDeviceClass.TEMPERATURE,
                "unit": UnitOfTemperature.CELSIUS,
                "state_class": SensorStateClass.MEASUREMENT,
                "default": False,
            ...
            C3Attributes.temp_t4: {
                ...
                "name": "T4 Temperature (Outdoor Ambient)",
                "device_class": SensorDeviceClass.TEMPERATURE,
                "unit": UnitOfTemperature.CELSIUS,
                "state_class": SensorStateClass.MEASUREMENT,
                "default": False,
            ...
            C3Attributes.temp_t5: {
                ...
                "name": "T5 Temperature (Water Tank)",
                "device_class": SensorDeviceClass.TEMPERATURE,
                "unit": UnitOfTemperature.CELSIUS,
                "state_class": SensorStateClass.MEASUREMENT,
                "default": False,
            ...
            C3Attributes.temp_tf: {
                ...
                "name": "TF Module Temperature (PCB)",
                "device_class": SensorDeviceClass.TEMPERATURE,
                "unit": UnitOfTemperature.CELSIUS,
                "state_class": SensorStateClass.MEASUREMENT,
                "default": False,
            ...
            C3Attributes.temp_th: {
                ...
                "name": "TH Temperature (Compressor Suction)",
                "device_class": SensorDeviceClass.TEMPERATURE,
                "unit": UnitOfTemperature.CELSIUS,
                "state_class": SensorStateClass.MEASUREMENT,
                "default": False,
            ...
            C3Attributes.temp_tp: {
                ...
                "name": "TP Temperature (Compressor Discharge)",
                "device_class": SensorDeviceClass.TEMPERATURE,
                "unit": UnitOfTemperature.CELSIUS,
                "state_class": SensorStateClass.MEASUREMENT,
                "default": False,
            ...
            C3Attributes.SysEnergyAnaEN: {
                "type": Platform.BINARY_SENSOR,
                "translation_key": "SysEnergyAnaEN",
                "name": "System Energy Analysis Enabled",
                "icon": "mdi:chart-line",
                "default": False,
            },
            C3Attributes.HMIEnergyAnaSetEN: {
                "type": Platform.BINARY_SENSOR,
                "translation_key": "HMIEnergyAnaSetEN",
            ...
            C3Attributes.total_electricity0: {
                ...
                "name": "Total Electricity Consumption (raw)",
                "device_class": SensorDeviceClass.ENERGY,
                "unit": UnitOfEnergy.KILO_WATT_HOUR,
                "state_class": SensorStateClass.TOTAL_INCREASING,
                "default": False,
            ...
            C3Attributes.odu_plan_vol_lmt: {
                ...
                "name": "ODU Current Limitation Code",
                "icon": "mdi:help-box-outline",
                "entity_category": "diagnostic",
                "default": False,
            },
            ...
            C3Attributes.idu_t1s1: {
                ...
                "name": "Zone1 Calculated T1s (curve)",
                "icon": "mdi:help-box-outline",
                "entity_category": "diagnostic",
                "default": False,
            },
            C3Attributes.idu_t1s2: {
                ...
                "name": "Zone2 Calculated T1s (curve)",
                "icon": "mdi:help-box-outline",
                "entity_category": "diagnostic",
                "default": False,
            },
            ...
            C3Attributes.zone1_temp_set: {
                ...
                "name": "Zone1 Temperature Set (raw)",
                "icon": "mdi:help-box-outline",
                "entity_category": "diagnostic",
                "default": False,
            },
            C3Attributes.zone2_temp_set: {
                ...
                "name": "Zone2 Temperature Set (raw)",
                "icon": "mdi:help-box-outline",
                "entity_category": "diagnostic",
                "default": False,
            },
            ...
            C3Attributes.temp_t4a_ver: {
                ...
                "name": "T4A / Version byte (raw, meaning unverified)",
                "icon": "mdi:help-box-outline",
                "entity_category": "diagnostic",
                "default": False,
            },
