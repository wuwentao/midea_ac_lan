...
MIDEA_DEVICES: dict[int, dict[str, dict[str, Any] | str]] = {
    ...
    0xE3: {
        ...
        "entities": {
            ...
            # Cloud only usage report (dayReportV2). These rows are created by
            # sensor.py only when the optional cloud account is configured; the
            # "cloud_report" field names the E3DayReport attribute to expose.
            "cloud_water_usage_daily": {
                "type": Platform.SENSOR,
                "translation_key": "cloud_water_usage_daily",
                ...
                "cloud_report": "water_daily",
                "cloud_report_period": "daily",
            },
            "cloud_gas_usage_daily": {
                "type": Platform.SENSOR,
                "translation_key": "cloud_gas_usage_daily",
                ...
                "cloud_report": "gas_daily",
                "cloud_report_period": "daily",
            },
            "cloud_duration_daily": {
                "type": Platform.SENSOR,
                "translation_key": "cloud_duration_daily",
                "name": "Daily Hot Water Duration",
                "icon": "mdi:timer-outline",
                "device_class": SensorDeviceClass.DURATION,
                "unit": UnitOfTime.MINUTES,
                "state_class": SensorStateClass.MEASUREMENT,
                "suggested_display_precision": 1,
                "cloud_report": "duration_daily",
                "cloud_report_period": "daily",
            },
            "cloud_water_usage_monthly": {
                "type": Platform.SENSOR,
                "translation_key": "cloud_water_usage_monthly",
                ...
                "state_class": SensorStateClass.TOTAL,
                "suggested_display_precision": 1,
                "cloud_report": "water_monthly",
                "cloud_report_period": "monthly",
                "cloud_report_last_month": "water_last_month",
            },
            "cloud_gas_usage_monthly": {
                "type": Platform.SENSOR,
                "translation_key": "cloud_gas_usage_monthly",
                ...
                "state_class": SensorStateClass.TOTAL,
                "suggested_display_precision": 2,
                "cloud_report": "gas_monthly",
                "cloud_report_period": "monthly",
                "cloud_report_last_month": "gas_last_month",
            },
        },
    },
    0xE6: {
