...
# E2 extended entities need a matching midealocal (e.g. error_code, flow_rate, … on DeviceAttributes).
_E2_EXTENDED_ENTITIES: dict[str, dict[str, Any]] = {
    "error_code": {
        "type": Platform.SENSOR,
        "translation_key": "error_code",
        "name": "Error Code",
...
for _e2_name, _e2_entity in _E2_EXTENDED_ENTITIES.items():
    if hasattr(E2Attributes, _e2_name):
        MIDEA_DEVICES[0xE2]["entities"][
            getattr(E2Attributes, _e2_name)
        ] = _e2_entity
