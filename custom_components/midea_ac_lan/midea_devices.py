...
MIDEA_DEVICES: dict[int, dict[str, dict[str, Any] | str]] = {
    ...
    0xE2: {
        ...
        "entities": {
            ...
            E2Attributes.discharge_left_time: {
                "type": Platform.SENSOR,
                "translation_key": "discharge_left_time",
                "name": "Discharge Time Remaining",
                "icon": "mdi:timer-outline",
                "unit": UnitOfTime.MINUTES,
                "state_class": SensorStateClass.MEASUREMENT,
            },
            E2Attributes.sterilize_left_days: {
                "type": Platform.SENSOR,
                "translation_key": "sterilize_left_days",
                "name": "Sterilize Days Remaining",
                "icon": "mdi:calendar-clock",
                "unit": UnitOfTime.DAYS,
                "state_class": SensorStateClass.MEASUREMENT,
            },
            E2Attributes.sterilize_cycle_index: {
                "type": Platform.SENSOR,
                "translation_key": "sterilize_cycle_index",
                "name": "Sterilize Cycle Index",
                "icon": "mdi:counter",
                "state_class": SensorStateClass.MEASUREMENT,
            },
            E2Attributes.uv_sterilize_minute: {
                "type": Platform.SENSOR,
                "translation_key": "uv_sterilize_minute",
                "name": "UV Sterilize Minute",
                "icon": "mdi:timer-outline",
                "unit": UnitOfTime.MINUTES,
                "state_class": SensorStateClass.MEASUREMENT,
            },
            E2Attributes.uv_sterilize_second: {
                "type": Platform.SENSOR,
                "translation_key": "uv_sterilize_second",
            ...
            E2Attributes.in_temperature: {
                "type": Platform.SENSOR,
                "translation_key": "in_temperature",
                "name": "Inlet Temperature",
                "device_class": SensorDeviceClass.TEMPERATURE,
                "unit": UnitOfTemperature.CELSIUS,
                "state_class": SensorStateClass.MEASUREMENT,
            },
            E2Attributes.heat_water_level: {
                "type": Platform.SENSOR,
                "translation_key": "heat_water_level",
                "name": "Heat Water Level",
                "icon": "mdi:cup-water",
                "unit": PERCENTAGE,
                "state_class": SensorStateClass.MEASUREMENT,
            },
            E2Attributes.half_heat: {
                "type": Platform.BINARY_SENSOR,
                "translation_key": "half_heat",
                "name": "Half Tank Heating",
                "icon": "mdi:chart-donut",
                "device_class": BinarySensorDeviceClass.RUNNING,
            },
            E2Attributes.target_temperature: {
                "type": Platform.SENSOR,
            ...
            E2Attributes.day_water_consumption: {
                "type": Platform.SENSOR,
                "translation_key": "day_water_consumption",
            ...
            E2Attributes.discharge_status: {
                "type": Platform.SENSOR,
                "translation_key": "discharge_status",
                "name": "Discharge Status",
                "icon": "mdi:pipe-valve",
                "state_class": SensorStateClass.MEASUREMENT,
            },
            E2Attributes.fast_hot_power: {
                "type": Platform.BINARY_SENSOR,
                "translation_key": "fast_hot_power",
                "name": "Fast Hot Power",
                "icon": "mdi:flash",
                "device_class": BinarySensorDeviceClass.RUNNING,
            },
            ...
            E2Attributes.limit_error: {
                "type": Platform.BINARY_SENSOR,
                "translation_key": "limit_error",
                "name": "Limit Error",
                "icon": "mdi:alert-octagon",
                "device_class": BinarySensorDeviceClass.PROBLEM,
            },
            E2Attributes.communication_error: {
                "type": Platform.BINARY_SENSOR,
            ...
            E2Attributes.ele_exception: {
                "type": Platform.BINARY_SENSOR,
                "translation_key": "ele_exception",
                "name": "Electrical Exception",
                "icon": "mdi:flash-alert",
                "device_class": BinarySensorDeviceClass.PROBLEM,
            },
            E2Attributes.elec_warning: {
                "type": Platform.BINARY_SENSOR,
                "translation_key": "elec_warning",
                "name": "Electrical Warning",
                "icon": "mdi:flash-alert-outline",
                "device_class": BinarySensorDeviceClass.PROBLEM,
            },
            E2Attributes.bottom_temp: {
                "type": Platform.BINARY_SENSOR,
                "translation_key": "bottom_temperature",
...
# C1 standby requires midealocal with DeviceAttributes.standby (newer than some PyPI releases).
if hasattr(C1Attributes, "standby"):
    MIDEA_DEVICES[0xC1]["entities"][C1Attributes.standby] = {
        "type": Platform.BINARY_SENSOR,
        "translation_key": "standby",
        "name": "Standby",
        "icon": "mdi:power-sleep",
